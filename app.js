...
function displayMenuItems(menuItems){
  //MAP method can manipulate the internal HTML and stuff
...
function displayMenuButtons(menuList){

  //value denotes the [all] and items denotes each item in menu array
  let categories = menu.reduce(function(values, items){
  ...
  containerBtn.innerHTML = categoriesBtn
  ...
  filterBtns.forEach(function(btn){
    btn.addEventListener("click", function(e){
      ...
      //make a new array according to the filter
